...
import { invoiceService, inventoryService, purchaseService } from '@/services/api';
      ...
      const revenueData = lastSixMonths.map(monthData => {
        const monthRevenue = invoices
          .filter(invoice => {
            ...
            return invoiceDate.getMonth() === monthData.fullDate.getMonth() && 
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-success mt-1">
              {calculatePercentageChange(dashboardData.todaySales)} from yesterday
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-success mt-1">
              {calculatePercentageChange(dashboardData.totalOrders)} from last week
            </p>
          </CardContent>
        </Card>
      </div>
              ...
              dashboardData.recentOrders.map((order) => (
                <div key={order.id} className="flex items-center justify-between border-b border-border pb-3 last:border-0">
                  ...
                  <div className="text-right space-y-1">
                    <p className="text-sm font-bold text-foreground">AED {order.amount.toFixed(2)}</p>
